 ...
 * of edges.
 * A <em>perfect matching</em> is a matching which matches all vertices in the
 * graph.
 * A <em>vertex cover</em> in a graph is a subset of its vertices such that
 * every edge is incident to at least one vertex. A <em>minimum vertex
 * cover</em>
...
public class BipartiteMatching {
     ...
     * - if not, upon termination marked[] specifies those vertices reachable via an
     * alternating
