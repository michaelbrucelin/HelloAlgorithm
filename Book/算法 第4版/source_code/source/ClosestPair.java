 ...
 * <a href="https://algs4.cs.princeton.edu/99hull">Section 9.9</a> of
...
public class ClosestPair {
    ...
    // precondition: pointsByX[lo..hi] and pointsByY[lo..hi] are the same sequence
    // of points
            ...
            for (int j = i + 1; (j < m) && (aux[j].y() - aux[i].y() < delta); j++) {
                ...
                if (distance < delta) {
                    ...
                    if (distance < bestDistance) {
                        ...
                        best1 = aux[i];
                        best2 = aux[j];
                        // StdOut.println("better distance = " + delta + " from " + best1 + " to " +
                        // best2);
                    }
                }
            }
